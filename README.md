...
$$
<任务名>_NO_<编号>_<图代号>_<起始时间>-<结束时间>.png
$$
...
**时间读取与标记逻辑：**
用户在标记第一张图的时候，需要首先标记时间起始点，假设起始点的x坐标为$x_start$与$x_end$标记区域的起始点为$x$与$x'$起始时间为$t_start$与$t_end$，则时间按以下公式读取：
$$
...
## 使用教程
(2025年11月7日11点45分 Neu:先写到这里把，饿死我了)